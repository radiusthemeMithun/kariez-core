...
class RTDemoimport {
	...
	public function custom_admin_css( $hook_suffix ) {
		if ( 'appearance_page_install_demos' === $hook_suffix ) {
			wp_enqueue_style( 'custom-admin-css', KARIEZ_CORE_BASE_URL . '/demo-content/css/main.css', [], '1.0.0' );
		}
	}
	...
	public function import_page_setup( $default_settings ) {
		...
		$default_settings['page_title']  = esc_html__( 'Import Demo Data', 'kariez-core' );
		$default_settings['menu_title']  = esc_html__( 'Import Demo Data', 'kariez-core' );
	...
	public function intro_text( $default_text ) {
        ...
        <div class="kariez-core_intro-text vtdemo-one-click">
            <div id="poststuff">
                ...
                <div class="postbox vt-support-box">
                    ...
                    <div class="inside">
                        ...
                        <a href="https://themeforest.net/item/kariez/123456?ref=rt" class="button-primary" target="_blank">Item Page</a>
                    </div>
                </div>
...
add_action( 'plugins_loaded', 'kariez_demo_importer_init' );
/**
 * Initializes the Quixa demo importer.
 *
 * @return RTDemoimport
 */
function kariez_demo_importer_init() {
