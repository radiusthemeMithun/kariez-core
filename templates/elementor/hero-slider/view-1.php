...
<div class="rt-hero-slider">
                        ...
                        <div class="content-wrap">
                            ...
                            <?php if( !empty( $banner['button_text'] ) ) { ?>
                                <div class="slider-btn-area rt-button">
                                    <a class="btn button-1" href="<?php echo esc_url( $banner['button_url'] ); ?>"><?php echo kariez_html( $banner['button_text'], 'allow_title' );?></a>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
    ...
    <?php if ( $display_arrow == 'yes' ) { ?>
        <div class="swiper-navigation">
            <div class="swiper-button swiper-button-prev"><i class="icon-angle-left"></i></div>
            <div class="swiper-button swiper-button-next active"><i class="icon-angle-right"></i></div>
        </div>
    <?php } ?>
