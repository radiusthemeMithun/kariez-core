...
$category_dropdown = array(  0 => __( 'All Category', 'kariez-core' ) );
            ...
            <div class="search-box-text-field">
                <div class="input-area d-flex align-items-center">
                    <div class="input-group-addon rt-input-wrap flex-grow-1">
                        <input type="text" class="search-box-input" name="s" id="searchInput" placeholder="<?php kariez_html( $placeholder, 'allow_title' );?>" autocomplete="off">
