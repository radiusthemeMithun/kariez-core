...
?>
<div class="rt-project-default rt-project-multi-layout-default project-grid-<?php echo esc_attr( $layout );?> <?php if ( $all_button == 'hide' ) { ?>hide-all<?php } ?> rt-isotope-wrapper">
