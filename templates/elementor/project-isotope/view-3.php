...
?>
<div class="rt-project-default rt-project-multi-layout-3 project-grid-<?php echo esc_attr( $layout );?> <?php if ( $all_button == 'hide' ) {?>hide-all<?php } ?> rt-isotope-wrapper">
