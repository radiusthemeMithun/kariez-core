    ...
    <div class="row <?php echo esc_attr( $item_space ); ?>">
		...
		if ( $query->have_posts() ) {
            while ( $query->have_posts() ) {
                ...
                $content = "$content";
                ?>
                <div class="<?php echo esc_attr( $col_class ); ?> <?php echo esc_attr( $animation ); ?> <?php echo esc_attr( $animation_effect ); ?>"
                     data-wow-delay="<?php echo esc_attr( $ade ); ?>ms" data-wow-duration="<?php echo esc_attr( $adu ); ?>ms">
                    <div class="team-item">
                                ...
                                <?php if ( $social_display ) { ?>
                                    <ul class="team-social">
                                        <?php foreach ( $socials as $key => $value ):
                                            ...
                                            ?>
                                            <?php if ( ! empty( $value ) ): ?>
                                            <li class="social-item"><a class="social-link" target="_blank"
                                                                       href="<?php echo esc_url( $value ); ?>"
                                                                       aria-label="social link"><i
                                                            class="<?php echo esc_attr( $socials_fields[ $key ]['icon'] ); ?>"
