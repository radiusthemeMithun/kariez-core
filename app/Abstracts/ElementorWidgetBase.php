...
namespace RT\KariezCore\Abstracts;
...
abstract class ElementorWidgetBase extends Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		$this->kariez_category = KARIEZ_CORE_PREFIX . '-widgets'; // Category /@dev
		$this->kariez_icon     = 'rdtheme-el-custom';
	}
	...
	protected function register_controls() {
		...
		foreach ( $fields as $id => $field ) {
			$field['classes'] = ! empty( $field['classes'] ) ? $field['classes'] . ' elementor-control-kariez_el' : ' elementor-control-kariez_el';
		...
		do_action( 'kariez/after/register/controls' );
	}
