...
namespace RT\KariezCore;
use RT\KariezCore\Hooks\FilterHooks;
use RT\KariezCore\Hooks\ActionHooks;
...
final class Init {
	...
	public function __construct() {
		add_action( 'kariez_theme_init', [ $this, 'after_theme_loaded' ] );
	...
	public function load_textdomain() {
		load_plugin_textdomain( 'kariez-core', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
	}
