...
class WidgetOverwrite {
	...
	public function __construct() {
		...
		add_action( 'in_widget_form', [ $this, 'kariez_in_widget_form' ], 5,
			3 );
		//Callback function for options update (priorität 5, 3 parameters)
		add_filter( 'widget_update_callback',
			[ $this, 'kariez_in_widget_form_update' ], 5, 3 );
		//add class names (default priority, one parameter)
		add_filter( 'dynamic_sidebar_params',
			[ $this, 'kariez_dynamic_sidebar_params' ] );
	}

	function kariez_in_widget_form( $t, $return, $instance ) {
	...
	function kariez_in_widget_form_update(
	...
	function kariez_dynamic_sidebar_params( $params ) {
